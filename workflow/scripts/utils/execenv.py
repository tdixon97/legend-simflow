...
def dataprod() -> None:
    ...
    if args.verbose:
        ...
        logger = logging.getLogger("legendsimflow")
...
def install(args) -> None:
    ...
    .. code-block:: console
      ...
      $ dataprod install --editable config.yaml  # install legend-simflow in editable mode
    ...
    # and finally install legendsimflow with all dependencies
